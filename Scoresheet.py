...
class Scoresheet(QWidget):
    ...
    def createGridLayout(self):
        ...
        self.createDropDown(1, self.q1Label, self.q1Point, self.q1Type, self.q1Part)
        ...
        self.createDropDown(2, self.q2Label, self.q2Point, self.q2Type, self.q2Part)
        ...
        self.createDropDown(3, self.q3Label, self.q3Point, self.q3Type, self.q3Part)
        ...
        self.createDropDown(4, self.q4Label, self.q4Point, self.q4Type, self.q4Part)
        ...
        self.createDropDown(5, self.q5Label, self.q5Point, self.q5Type, self.q5Part)
        ...
        self.createDropDown(6, self.q6Label, self.q6Point, self.q6Type, self.q6Part)
        ...
        self.createDropDown(7, self.q7Label, self.q7Point, self.q7Type, self.q7Part)
        ...
        self.createDropDown(8, self.q8Label, self.q8Point, self.q8Type, self.q8Part)
        ...
        self.createDropDown(9, self.q9Label, self.q9Point, self.q9Type, self.q9Part)
        ...
        self.createDropDown(10, self.q10Label, self.q10Point, self.q10Type, self.q10Part)
        ...
        self.createDropDown(11, self.q11Label, self.q11Point, self.q11Type, self.q11Part)
        ...
        self.createDropDown(12, self.q12Label, self.q12Point, self.q12Type, self.q12Part)
        ...
        self.createDropDown(13, self.q13Label, self.q13Point, self.q13Type, self.q13Part)
        ...
        self.createDropDown(14, self.q14Label, self.q14Point, self.q14Type, self.q14Part)
        ...
        self.createDropDown(15, self.q15Label, self.q15Point, self.q15Type, self.q15Part)
        ...
        self.createDropDown(16, self.q16Label, self.q16Point, self.q16Type, self.q16Part)
        ...
        self.createDropDown(17, self.q17Label, self.q17Point, self.q17Type, self.q17Part)
        ...
        self.createDropDown(18, self.q18Label, self.q18Point, self.q18Type, self.q18Part)
        ...
        self.createDropDown(19, self.q19Label, self.q19Point, self.q19Type, self.q19Part)
        ...
        self.createDropDown(20, self.q20Label, self.q20Point, self.q20Type, self.q20Part)
        ...
        self.createDropDown(21, self.ot1Label, self.ot1Point, self.ot1Type, self.ot1Part)
        ...
        self.createDropDown(22, self.ot2Label, self.ot2Point, self.ot2Type, self.ot2Part)
        ...
        self.createDropDown(23, self.ot3Label, self.ot3Point, self.ot3Type, self.ot3Part)
